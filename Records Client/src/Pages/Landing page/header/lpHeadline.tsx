...
const Headline = () => {
  return (
    <div className="relative max-md:hidden bg-gradient-to-r from-[var(--primary)] to-[var(--secondary)] p-8 mx-2 mt-1 rounded-lg shadow-lg text-center overflow-hidden">
    <div className="absolute inset-0 bg-gradient-to-b from-transparent to-purple-900 opacity-30"></div>
    <h1 className="text-5xl font-bold hFont text-white mb-4 relative z-10">Hey there, Welcome back!</h1>
